...
/**
 * A read-only REST resource that provides a collection of metrics for shows
 * occuring in the future. Updates to metrics via POST/PUT etc. are not allowed,
 * since they are not meant to be computed by consumers.
 * 
...
public class MetricsService {
	...
	/**
	 * Retrieves a collection of metrics for Shows. Each metric in the
	 * collection contains
	 * <ul>
	 * <li>the show id,</li>
